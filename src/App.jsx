...
const KNOWN_ROUTES = ['about', 'contact', 'terms', 'privacy', 'disclosure', 'thank-you', 'how-it-works', 'austeriosmart-up-review-australia-scam', 'faq']
...
export default function App() {
  ...
  // Shared page shell, SEO head metadata, header, main, footer. All route
  // components are eagerly loaded, so navigating never shows a blank page.
